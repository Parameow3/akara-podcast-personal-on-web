...
public class MediaPlayerController implements Initializable {
    ...
    private static List<String> songsUrl;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        songsUrl = RandomSoundPodcast.getAllURL();

//        directory = new File("src/podcastSound");
//
...
//        else System.out.println("It's null");
    ...
    void prevoiusMedia(ActionEvent event) {
        ...
        if (songNumber > 0) {
            ...
            mediaStatic = new Media(songsUrl.get(songNumber));
            mediaPlayerStatic = new MediaPlayer(mediaStatic);
